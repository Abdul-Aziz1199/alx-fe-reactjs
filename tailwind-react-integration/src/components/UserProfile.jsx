...
function UserProfile() {
    return (
      <div className="hover:shadow-xl bg-gray-100 p-4 sm:p-4 md:p-8 max-w-xs sm:max-w-sm md:max-w-sm  md:max-w-md mx-auto my-10 md:my-20 rounded-lg shadow-lg text-center">
        <img src="https://via.placeholder.com/150" alt="User" className=" hover:scale-100 transition-transform duration-300 ease-in-out w-24 h-24 sm:w-24 sm:h-24 md:w-36 md:h-36 rounded-full mx-auto" />
